...
\begin{bullets}
  ...
  \item \bullettitle{Coursework} Object-Oriented and Advanced Programming, Intro to Operating Systems,
        Web Systems, Intro to Computer Security, Database Management Systems, Intro to Artificial Intelligence,
...
\job{Instructional Aide for EECS 482 (Intro to Operating Systems)}{Jan. 2017 -- Dec. 2017}
\begin{bullets}
